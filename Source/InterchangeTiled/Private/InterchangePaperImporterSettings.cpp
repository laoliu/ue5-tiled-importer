...
#include UE_INLINE_GENERATED_CPP_BY_NAME(InterchangePaperImporterSettings)

//////////////////////////////////////////////////////////////////////////
// UInterchangePaperImporterSettings

UInterchangePaperImporterSettings::UInterchangePaperImporterSettings()
...
FString UInterchangePaperImporterSettings::RemoveSuffixFromBaseMapName(const FString& InName) const
{
...
void UInterchangePaperImporterSettings::GenerateNormalMapNamesToTest(const FString& InRoot, TArray<FString>& InOutNames) const
{
...
void UInterchangePaperImporterSettings::ApplyTextureSettings(UTexture2D* Texture) const
{
...
ESpriteInitMaterialType UInterchangePaperImporterSettings::AnalyzeTextureForDesiredMaterialType(UTexture* Texture, const FIntPoint& Offset, const FIntPoint& Dimensions) const
{
...
void UInterchangePaperImporterSettings::ApplySettingsForSpriteInit(FSpriteAssetInitParameters& InitParams, ESpriteInitMaterialLightingMode LightingMode, ESpriteInitMaterialType MaterialTypeMode) const
{
...
void UInterchangePaperImporterSettings::ApplySettingsForTileMapInit(UPaperTileMap* TileMap, UPaperTileSet* DefaultTileSet, ESpriteInitMaterialLightingMode LightingMode, ESpriteInitMaterialType MaterialTypeMode, bool bCreateEmptyLayer) const
{
...
UMaterialInterface* UInterchangePaperImporterSettings::GetDefaultTranslucentMaterial(bool bLit) const
{
	return Cast<UMaterialInterface>((bLit ? LitDefaultTranslucentMaterialName : UnlitDefaultTranslucentMaterialName).TryLoad());
}

UMaterialInterface* UInterchangePaperImporterSettings::GetDefaultOpaqueMaterial(bool bLit) const
{
	return Cast<UMaterialInterface>((bLit ? LitDefaultOpaqueMaterialName : UnlitDefaultOpaqueMaterialName).TryLoad());
}

UMaterialInterface* UInterchangePaperImporterSettings::GetDefaultMaskedMaterial(bool bLit) const
{
	return Cast<UMaterialInterface>((bLit ? LitDefaultMaskedMaterialName : UnlitDefaultMaskedMaterialName).TryLoad());
}

UMaterialInterface* UInterchangePaperImporterSettings::GetDefaultMaterial(ESpriteInitMaterialType MaterialType, bool bUseLitMaterial) const
{
	...
	{
	default:
		ensureMsgf(false, TEXT("Unexpected material type in UInterchangePaperImporterSettings::GetDefaultMaterial"));
		// Fall thru
